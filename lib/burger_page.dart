      ...
      children: <Widget>[
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
          Container(
              ...
              child: Center(
                  child: Text(
                'R\$' + (int.parse(widget.pricePerItem) * quantity).toString(),
                style: GoogleFonts.notoSans(
                    fontSize: 40.0,
    ...
    return Padding(
        ...
        child: Column(
          children: <Widget>[
            ...
            if (columnNumber == '1')
              _buildColumnItem('assets/cheese.png', 'Queijo quente', '11',
                  Color(0xFFFBD6F5)),
            if (columnNumber == '1') SizedBox(height: 15.0),
            if (columnNumber == '1')
              _buildColumnItem(
                  'assets/popcorn.png', 'Pipoca doce', '11', Color(0xFFFBD6F5)),
            if (columnNumber == '2')
              _buildColumnItem(
            ...
            if (columnNumber == '2')
              _buildColumnItem(
                  'assets/sandwich.png', 'Sanduiche', '6', Color(0xFFD7FADA)),
          ],
        ));
  }
